...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-5 text-base font-medium text-text-primary transition-all hover:text-teal-light text-left [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
